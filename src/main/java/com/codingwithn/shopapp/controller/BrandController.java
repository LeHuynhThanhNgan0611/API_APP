...
public class BrandController {
    ...
    public List<Brand> getAllBrand() {
        ...
        brands.add(new Brand("8", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713274378/brand/adidas.png", "Kenwood", 36, false));
        brands.add(new Brand("9", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713274378/brand/adidas.png", "IKEA", 36, false));
