...
public class CategoryController {
    ...
    public CategoryController() {
        List<Product> theThaoProducts = List.of(
                new Product(
                        "001",
                        15,
                        "ABR4568",
        ...
        List<Product> dienTuProducts = List.of(
                new Product(
                        "006",
                        15,
                        "ABR4568",
        ...
        List<Product> thoiTrangProducts = List.of(
                new Product(
                        "007",
                        15,
                        "ABR4568",
        ...
        List<Product> trangSucProducts = List.of(
                new Product(
                        "009",
                        15,
                        "ABR4568",
        ...
        categories.add(new Category("1", "Thể thao", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/thethao.png", null, true, theThaoProducts));
        categories.add(new Category("2", "Điện tử", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/thietbidientu.png", null, true, dienTuProducts));
        categories.add(new Category("3", "Nội thất", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/noithat.png", null, true, null));
        categories.add(new Category("4", "Thời trang", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/quanao.png", null, true, thoiTrangProducts));
        categories.add(new Category("5", "Thú cưng", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/thucung.png", null, true, null));
        categories.add(new Category("6", "Giày dép", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/giaydep.png", null, true, null));
        categories.add(new Category("7", "Làm đẹp", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/lamdep.png", null, true, null));
        categories.add(new Category("8", "Trang sức", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/trangsuc.png", null, true, trangSucProducts));
    ...
    private List<Category> getSportSubcategories() {
        List<Product> dungcuthethaoProducts = new ArrayList<>();
        dungcuthethaoProducts.add(new Product(
                "022",
                15,
                "ABR4568",
                950,
        ...
        List<Product> giayTheThaoProducts = List.of(
                new Product(
                        "014",
                        15,
                        "ABR4568",
        ...
        List<Product> quanAoTheThaoProducts = List.of(
                new Product(
                        "018",
                        15,
                        "ABR4568",
        ...
        sportSubcategories.add(new Category("9", "Giày thể thao", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/thethao.png", "1", false, giayTheThaoProducts));
        sportSubcategories.add(new Category("10", "Quần áo thể thao", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/thethao.png", "1", false, quanAoTheThaoProducts));
        sportSubcategories.add(new Category("11", "Dụng cụ thể thao", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/thethao.png", "1", false, dungcuthethaoProducts));
        // Thêm danh sách con khác nếu cần
        return sportSubcategories;
    }

    private List<Category> getEletricSubcategories() {
        List<Product> LaptopProducts = List.of(
                new Product(
                        "037",
                        15,
                        "ABR4568",
        ...
        List<Product> dienThoaiProducts = List.of(
                new Product(
                        "003",
                        15,
                        "ABR4568",
        ...
        electricSubcategories.add(new Category("15", "Laptop", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/thietbidientu.png", "2", false, LaptopProducts));
        electricSubcategories.add(new Category("16", "Điện thoại", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/thietbidientu.png", "2", false, dienThoaiProducts));
        // Thêm danh sách con khác nếu cần
    ...
    private List<Category> getFashionSubcategories() {
        ...
        fashionSubcategories.add(new Category("17", "Áo thun", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/quanao.png", "4", false, null));
        // Thêm danh sách con khác nếu cần
        return fashionSubcategories;
    }
    private List<Category> getFutureSubcategories() {
        List<Product> noiThatPhongNguProducts = List.of(
                new Product(
                        "026",
                        15,
                        "ABR4568",
        ...
        List<Product> noiThatNhaBepProducts = List.of(
                new Product(
                        "029",
                        15,
                        "ABR4568",
        ...
        List<Product> noiThatVanPhongProducts = List.of(
                new Product(
                        "033",
                        15,
                        "ABR4568",
        ...
        futureSubcategories.add(new Category("12", "Nội thất phòng ngủ", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/noithat.png", "3", false, noiThatPhongNguProducts));
        futureSubcategories.add(new Category("13", "Nội thất nhà bếp", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/noithat.png", "3", false, noiThatNhaBepProducts));
        futureSubcategories.add(new Category("14", "Nội thất văn phòng", "https://res.cloudinary.com/ddbvpbkql/image/upload/v1713259334/category/noithat.png", "3", false, noiThatVanPhongProducts));
        // Thêm danh sách con khác nếu cần
    ...
    public Category getCategoryById(@PathVariable String id) {
        // Tìm danh mục với ID đã cho
        Category category = findCategoryById(id);

        if (category != null) {
            // Lấy danh sách các danh mục con của danh mục đã tìm thấy
            List<Category> children = getChildren(category);
            // Gán danh sách các danh mục con cho thuộc tính children của danh mục
            category.setChildren(children);
        }

        return category; // Trả về danh mục với danh sách con của nó
    }

    // Phương thức tìm một danh mục theo ID
    private Category findCategoryById(String id) {
        ...
        return null; // Trả về null nếu không tìm thấy danh mục với ID đã cho
    }

    // Phương thức đệ quy để lấy tất cả các danh mục con của một danh mục
    private List<Category> getChildren(Category parent) {
        List<Category> children = new ArrayList<>();
        for (Category category : this.categories) {
            if (parent.getId().equals(category.getParentId())) {
                // Đệ quy để lấy danh sách các danh mục con của danh mục hiện tại
